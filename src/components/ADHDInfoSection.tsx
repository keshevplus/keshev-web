...
const DEFAULT_INFO = [
  { title: 'ADHD ניתן לטיפול!', desc: 'עם הערכה מדויקת ותוכנית טיפול מותאמת אישית, ניתן לשפר משמעותית את איכות החיים. הצעד הראשון הוא פנייה למומחה.' },
  { title: 'קשיים חברתיים', desc: 'קושי בתקשורת חברתית, ביצירת קשרים ובשמירה עליהם' },
  { title: 'זיהוי מוקדם', desc: 'הערכה מוקדמת של ADHD יכולה לסייע בהתמודדות טובה יותר עם האתגרים ובמציאת דרכים מתאימות להצלחה בלימודים ובחיים.' },
];
...
const DEFAULT_FAQ = [
  ...
  { q: 'כמה זמן לוקח תהליך ההערכה?', a: 'תהליך ההערכה המלא כולל מספר פגישות ואורך בממוצע 2-4 שבועות. התהליך כולל ריאיון קליני מעמיק, מבחנים ממוחשבים (MOXO), שאלונים ובדיקת מסמכים רפואיים רלוונטיים.' },
  { q: 'האם ההערכה מתאימה לכל הגילאים?', a: 'כן, אנו מספקים הערכה מקצועית לילדים מגיל 6, בני נוער ומבוגרים. לכל קבוצת גיל יש פרוטוקול הערכה מותאם המתחשב במאפיינים הייחודיים של אותו גיל.' },
  ...
  { q: 'האם יש צורך בהפניה מרופא?', a: 'לא, אין צורך בהפניה. ניתן לפנות ישירות למרפאה לקביעת תור להערכה. עם זאת, אם יש מסמכים רפואיים קודמים, מומלץ להביא אותם לפגישה הראשונה.' },
