      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="relative">
          ...
          <div className="relative bg-white/70 backdrop-blur-sm p-8 rounded-lg shadow-2xl">
            <h2 className="text-3xl font-bold text-gray-800 mb-4">אופס! העמוד לא נמצא</h2>
            <p className="text-gray-600 mb-8">
              נראה שהגעת לעמוד שלא קיים. אולי הקישור שבור או שהעמוד הוסר.
            </p>
            <Link
              to="/"
              className="inline-block bg-gradient-to-r from-purple-600 to-blue-500 text-white font-bold py-3 px-8 rounded-full hover:scale-105 transform transition-all duration-200 hover:shadow-lg"
            >
              חזרה לדף הבית
            </Link>
          </div>
