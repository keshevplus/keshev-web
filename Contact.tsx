...
export default function Contact() {
  ...
  return (
    <PageLayout 
      title={pageData[0]?.heading || 'יצירת קשר'} 
      background="bg-white" 
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-2 gap-1 items-start">
        ...
        <div>
          <div className="mb-8">
            <h2 className="text-xl md:text-xl font-bold text-green-800 text-right mb-4 transition-transform duration-300 ease-in-out hover:scale-105">
              יצירת קשר
            </h2>
            <p className="text-lg text-gray-700 mb-4 text-right">
              נשמח לשמוע ממך! השאר פרטים ונחזור אליך בהקדם האפשרי.
            </p>
          </div>
